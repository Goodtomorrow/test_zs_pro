...
return [
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'sXpF5qWUEKlwYPc1oBQd9MgGfn2NCxki',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'guests' => [
        'douyin' => [
            'code_url' => Env::get('douyin.code-url', ''),
            'client_key' => Env::get('douyin.client-key', ''),
            'redirect_uri' => Env::get('douyin.redirect-uri', ''),
            'access_token_url' => Env::get('douyin.access-token-url', ''),
            'base_uri' => Env::get('douyin.base-uri', ''),
            'keywords_video_search_url'=> Env::get('douyin.keywords-video-search-url', '')
        ]
    ]
];
